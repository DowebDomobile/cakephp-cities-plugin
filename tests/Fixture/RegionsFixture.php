...
class RegionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'regions_country_id' => ['type' => 'foreign', 'columns' => ['country_id'], 'references' => ['countries', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
    ];
     ...
     */
    public $records = [
        ['id' => 1, 'country_id' => 1, 'name' => 'Алтайский край'],
        ['id' => 2, 'country_id' => 1, 'name' => 'Республика Алтай'],
        ['id' => 3, 'country_id' => 2, 'name' => 'Неважно'],
    ];
}
